...
- ### Machine Learning
  ...
  - [Predict patient outcome using Pycaret](https://github.com/kh-bilal/Data-Science-Portfolio/tree/main/Predict_patient_outcome_using_Pycaret): In this project, we will use ‘diabetes’ dataset and the goal is to predict patient outcome (binary 1 or 0) .
